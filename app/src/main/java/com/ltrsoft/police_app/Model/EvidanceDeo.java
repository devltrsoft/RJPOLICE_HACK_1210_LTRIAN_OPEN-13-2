...
public class EvidanceDeo {
    ...
    public Evidance getoneEvidance( String evidance_id, Context context,Callback callback){
    ...
    public void GET_ALL_Complaint_EVIDENCE_by_complaint_id(String complaintId, Context context, Callback callback) {
